  ...
  return (
    <>
      ...
      <Menu
        ...
        sx={{ mt: 1 }}
      >
        <MenuItem component={NavLink} to={NAV_LINKS.profile}>
          My profile
        </MenuItem>
        <MenuItem component={NavLink} to={`${NAV_LINKS.repos}/Public`}>
          My repositories
        </MenuItem>
        <MenuItem component={NavLink} to={NAV_LINKS.searchUsers}>
          Search users
        </MenuItem>
